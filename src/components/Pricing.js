      ...
      <div className="grid max-w-md gap-10 row-gap-5 sm:row-gap-10 lg:max-w-screen-md lg:grid-cols-2 sm:mx-auto">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  ...
                  <p className="font-medium text-gray-800">Learn easy</p>
                </li>
                <li className="flex items-center">
                  <div className="mr-2">
                    <svg
                  ...
                  <p className="font-medium text-gray-800">Unlimited problem solve</p>
                </li>
                <li className="flex items-center">
                  <div className="mr-2">
                    <svg
        ...
        <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  ...
                  <p className="font-medium text-gray-800">given certificate</p>
                </li>
                <li className="flex items-center">
                  <div className="mr-2">
                    <svg
          ...
          <div>
            <a
              href="/"
              className="inline-flex items-center justify-center w-full h-12 px-6 mb-4 font-medium tracking-wide bg-slate-700 text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
            >
              Get started
            </a>
            <p className="text-sm text-gray-600">
